...
public:
    ...
    textureToUse (nullptr), lastTexture (nullptr)
    {
        ...
        juce::Array<ShaderPreset> shaders = getShaderPresets();
    ...
    void updateShader()
    {
        if (newVertexShader.isNotEmpty() || newFragmentShader.isNotEmpty())
        {
                ...
                && newShader->link())
            {
                ...
                shapePianoKey = std::make_unique<Shape> (openGLContext, BinaryData::pianokey_rectangle_obj);
                shapeTeapot   = std::make_unique<Shape> (openGLContext, BinaryData::teapot_obj);
